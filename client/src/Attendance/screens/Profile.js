  ...
  return (
    <div>
      <div style={{ display: "flex" }}>
        <div
          className="bg-dark"
          style={{ height: "880px", width: "15%", paddingTop: "1%" }}
        >
          <div>
            <ul style={{ listStyleType: "none" }}>
              <li>
                <Link to={`/student/dashboard`} className="link_class">
              ...
              <li>
                ...
                >
                  <i className="fas fa-calendar-plus"></i> Attendance
                </Link>
                <hr />
              </li>
              <li>
                <Link
                  ...
                  className="link_class"
                >
                  <i className="fal fa-table"></i> TimeTable
                </Link>
                <hr />
              </li>
              <li>
                <Link to={`/student/dashboard/mark`} className="link_class">
                  <i className="fas fa-poll-people"></i> Result
                </Link>
                <hr />
              </li>
              <li>
                <Link to={`/student/dashboard/subject`} className="link_class">
                  <i className="fad fa-books"></i> Subject
                </Link>
                <hr />
              </li>
              <li>
                {" "}
                <Link to={`/student/dashboard/joinclub`} className="link_class">
                  <i className="fab fa-gg-circle"></i> Join Club
                </Link>{" "}
                <hr />
              </li>
              <li>
                <Link to={`/student/dashboard/report`} className="link_class">
                  <i className="fal fa-bug"></i> Complain
                </Link>
                <hr />
              </li>
              <li>
                <Link to={`/student/dashboard/notice`} className="link_class">
                  <i className="fas fa-exclamation-square"></i> Notice
                </Link>
                <hr />
              </li>
              <li>
                <Link to={`/student/dashboard/payment`} className="link_class">
              ...
              >
                {" "}
                <i className="fad fa-sign-out"></i> Logout
                <hr />
              </li>
            </ul>
          </div>
