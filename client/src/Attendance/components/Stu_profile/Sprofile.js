...
const Sprofile = ({ user }) => {
  ...
  return (
    <div className="card " style={{ width: "50%", margin: "auto",marginTop:'10px' }}>
      {user && (
        <>
          <div>
            <div style={{ marginLeft: "34%", marginBottom: "20px" }}>
              ...
              />
              <div>
              <Link to="/student/dashboard/edit" className="edit_profile">
              {" "}
